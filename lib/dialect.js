...
class Dialect {
   ...
   * @param {Manager~Track} [track] A tracking mechanism that can be used to share configuration between dialect implementations
   ...
   * called from the return value of the {@link Manager~PreparedFunction}. Care must be taken not to drain the pool of available connections. 
   * @param {String} txId The internally generated transaction identifier
   * @param {Manager~TransactionOptions} opts The transaction options passed in via the public API
   */
   ...
   * @param {Manager~ExecMeta} meta The metadata used to generate the execution
